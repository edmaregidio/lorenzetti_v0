...
namespace xAOD{
  ...
  {  
    public:
      ...
      /*! Rp0 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rp0, setRp0, rp0 );
      /*! Rp1 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rp1, setRp1, rp1 );
      /*! Rp2 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rp2, setRp2, rp2 );
      /*! Rp3 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rp3, setRp3, rp3 );
      /*! RpHad1 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rphad1, setRphad1, rphad1 );
      /*! RpHad2 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rphad2, setRphad2, rphad2 );
      /*! RpHad3 */
      PRIMITIVE_SETTER_AND_GETTER( float, m_rphad3, setRphad3, rphad3 );
